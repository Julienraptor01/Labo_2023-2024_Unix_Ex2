...
#define QT_MOC_LITERAL(idx, ofs, len) Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, qptrdiff(offsetof(qt_meta_stringdata_MyWindow_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
...
void MyWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
	if (_c == QMetaObject::InvokeMetaMethod)
	{
		...
		{
		case 0:
			_t->on_pushButtonLogin_clicked();
			break;
		case 1:
			_t->on_pushButtonAfficheFichier_clicked();
			break;
		default:;
		}
	}
...
QT_INIT_METAOBJECT const QMetaObject MyWindow::staticMetaObject = {{&QMainWindow::staticMetaObject, qt_meta_stringdata_MyWindow.data, qt_meta_data_MyWindow, qt_static_metacall, nullptr, nullptr}};
