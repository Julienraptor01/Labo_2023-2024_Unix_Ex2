...
MAIN_BIN=$(BIN)$(MAIN)
# lists
HEADERS=$(MAIN_SRC)/ui_mywindow.h $(MAIN_SRC)/mywindow.h $(MAIN_SRC)/FichierUtilisateur.h
OBJECTS=$(MAIN_OBJ)/moc_mywindow.o $(MAIN_OBJ)/mywindow.o $(MAIN_OBJ)/main.o $(MAIN_OBJ)/FichierUtilisateur.o
### commands
# compile arguments
...
$(MAIN_OBJ)/moc_mywindow.o:	$(MAIN_SRC)/moc_mywindow.cpp $(HEADERS)
	$(LOG) '\n\033[42mcreation of the moc_mywindow object\033[49m\n'
	$(SRC_COMPILE) \
	$(SRC_COMPILE_ADD_ARGS) \
	$(MAIN_SRC)/moc_mywindow.cpp \
	-c \
	-o $(MAIN_OBJ)/moc_mywindow.o

$(MAIN_OBJ)/mywindow.o:	$(MAIN_SRC)/mywindow.cpp $(HEADERS)
	$(LOG) '\n\033[42mcreation of the mainwindow object\033[49m\n'
	$(SRC_COMPILE) \
	$(SRC_COMPILE_ADD_ARGS) \
	$(MAIN_SRC)/mywindow.cpp \
	-c \
	-o $(MAIN_OBJ)/mywindow.o
...
$(MAIN_OBJ)/FichierUtilisateur.o:	$(MAIN_SRC)/FichierUtilisateur.cpp $(HEADERS)
	$(LOG) '\n\033[42mcreation of the FichierUtilisateur object\033[49m\n'
	$(SRC_COMPILE) \
	$(MAIN_SRC)/FichierUtilisateur.cpp \
	-c \
	-o $(MAIN_OBJ)/FichierUtilisateur.o

$(MAIN_BIN)/Ex2:	$(OBJECTS)
